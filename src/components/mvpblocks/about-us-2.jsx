            ...
            <div className="relative z-10 container mx-auto max-w-6xl px-4 md:px-6">
                ...
                <div ref={aboutRef} className="relative mx-auto mb-20">
                    <div className="grid gap-16 md:grid-cols-2">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground text-base leading-relaxed">
                                ...
                                experiences, and create lasting value in an
                        ...
                        >
                            ...
                            <p className="text-muted-foreground text-base leading-relaxed">
                                To be the leading provider of transformative
                                digital experiences, recognized globally for our
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-base leading-relaxed">
                            We are a passionate team of experts dedicated to
                            delivering exceptional solutions that help
                            businesses thrive in the digital landscape. Our
                            commitment to innovation and quality has made us a
